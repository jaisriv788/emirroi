    ...
    >
      ...
      >
        ...
        <div className="flex flex-col gap-3">
          ...
          <div>
            <label className="text-lg font-semibold">Wallet Address</label>
            <input
              disabled
              placeholder="0x18683661330ab9B60429BD71cC1311F34b063A91"
          ...
          <div className="flex gap-3 text-red-500">
            ...
            <span className="font-semibold">Withdraw Capping Per Day $0</span>
          </div>
